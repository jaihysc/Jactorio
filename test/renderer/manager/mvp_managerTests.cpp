...
TEST(mvp_manager, projection_tile_calculation_and_matrix) {
	...
	// Matrix
	const auto proj_matrix = jactorio::renderer::Mvp_manager::to_proj_matrix(tile_prop, 0);
...
TEST(mvp_manager, projection_zoom) {
	...
	const auto proj_matrix = jactorio::renderer::Mvp_manager::to_proj_matrix(tile_prop, 10);
