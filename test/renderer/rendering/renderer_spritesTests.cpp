...
// 	};
// 	
// 	jactorio::renderer::Renderer_sprites::Sprite sprites[3] {
// 		{arr1, 5, 5},
// 		{arr2, 7, 5},
// 		{arr5, 5, 6},
// 	};
//
// 	const auto spritemap = jactorio::renderer::Renderer_sprites::gen_spritemap(sprites, 3);
//
// 	EXPECT_EQ(spritemap.spritemap.pixels_x, 17);
// 	EXPECT_EQ(spritemap.spritemap.pixels_y, 6);
// }