...
namespace jactorio::data
{
    ...
    TEST_F(DataManagerTest, DataRawGetInvalid) {
        ...
        const auto* ptr = dataManager_.DataRawGet<FrameworkBase>(DataCategory::sprite, "asdfjsadhfkjdsafhs");
    ...
    TEST_F(DataManagerTest, GetAllDataOfType) {
        ...
        const std::vector<Sprite*> paths = dataManager_.DataRawGetAll<Sprite>(DataCategory::sprite);
    ...
    TEST_F(DataManagerTest, GetAllSorted) {
        ...
        // Get
        const std::vector<Sprite*> protos = dataManager_.DataRawGetAllSorted<Sprite>(DataCategory::sprite);
