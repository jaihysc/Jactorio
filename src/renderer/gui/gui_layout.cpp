...
void renderer::DrawCursorTooltip(game::PlayerData& player_data,
...
void renderer::DrawSlots(const uint8_t slot_span,
...
void renderer::DrawItemSlot(const MenuData& menu_data,
                            const uint8_t scale,
