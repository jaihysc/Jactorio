...
void PrepareTransportSegmentData(renderer::RendererLayer& layer,
        ...
        *target_offset += line_item.dist.getAsDouble() * multiplier;
        ...
        layer.PushBack(
            {{
                 {
                     pixel_offset.x +
                         core::LossyCast<float>(tile_x) * core::SafeCast<float>(renderer::Renderer::tileWidth),
                     pixel_offset.y +
                         core::LossyCast<float>(tile_y) * core::SafeCast<float>(renderer::Renderer::tileWidth),
                 },
                 {
                     pixel_offset.x +
...
void renderer::DrawTransportSegmentItems(RendererLayer& layer,
                                         const SpriteUvCoordsT& uv_coords,
                                         const core::Position2<OverlayOffsetAxis>& pixel_offset,
...
void renderer::DrawInserterArm(RendererLayer& layer,
                               const SpriteUvCoordsT& uv_coords,
                               const core::Position2<OverlayOffsetAxis>& pixel_offset,
