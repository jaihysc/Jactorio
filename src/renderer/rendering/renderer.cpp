...
void renderer::Renderer::GlResizeWindow(const unsigned int window_x, const unsigned int window_y) noexcept {
...
const SpriteUvCoordsT::mapped_type& renderer::Renderer::GetSpriteUvCoords(
    const SpriteUvCoordsT& map, const SpriteUvCoordsT::key_type key) noexcept {
    try {
...
void renderer::Renderer::PrepareChunkRow(RendererLayer& r_layer,
                                         const game::WorldData& world_data,
                                         std::mutex& world_gen_mutex,
...
void renderer::Renderer::PrepareChunk(RendererLayer& r_layer,
...
void renderer::Renderer::PrepareTileLayers(RendererLayer& r_layer,
...
void renderer::Renderer::PrepareOverlayLayers(RendererLayer& r_layer,
                                              const game::Chunk& chunk,
...
void renderer::Renderer::ApplySpriteUvAdjustment(UvPositionT& uv, const UvPositionT& uv_offset) noexcept {
...
void renderer::Renderer::ApplyMultiTileUvAdjustment(UvPositionT& uv, const game::ChunkTileLayer& tile_layer) noexcept {
