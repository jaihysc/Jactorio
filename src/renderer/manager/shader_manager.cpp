 ...
 */
void jactorio_renderer_mvp::set_mvp_uniform_location(int location) {
 ...
 */
void jactorio_renderer_mvp::update_shader_mvp() {
	// Multiply backwards: projection, view, model
	glm::mat4 mvp = projection * view * model;
	Shader::set_uniform_mat_4f(mvp_uniform_location, mvp);
}

void jactorio_renderer_mvp::setg_model_matrix(const glm::mat4& matrix) {
	model = matrix;
}

void jactorio_renderer_mvp::setg_view_matrix(const glm::mat4 matrix) {
	view = matrix;
}

void jactorio_renderer_mvp::setg_projection_matrix(const glm::mat4 matrix) {
	projection = matrix;
}
