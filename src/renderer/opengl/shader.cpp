...
unsigned int jactorio::renderer::Shader::CompileShader(const std::string& filepath, const GLenum shader_type) {
...
jactorio::renderer::Shader::Shader(const std::vector<ShaderCreationInput>& inputs) : id_(0) {
...
int jactorio::renderer::Shader::GetUniformLocation(const std::string& name) const {
...
void jactorio::renderer::Shader::SetUniformMat4F(const int& location, glm::mat4& mat) {
