...
void UpdateSide(const data::LineDistT& tiles_moved, game::TransportSegment& segment) {
    ...
    if (index == 0) {
        ...
        /*
            ...
            switch (segment.terminationType) {
                // Due to how items feeding onto the sides of transport segments behave, they cannot be disabled unless
        empty case game::TransportSegment::TerminationType::left_only: case
        game::TransportSegment::TerminationType::right_only: break;
