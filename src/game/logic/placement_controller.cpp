...
bool jactorio::game::placement_location_valid(World_data& world_data,
...
bool jactorio::game::place_entity_at_coords(World_data& world_data,
                                            data::Entity* entity,
                                            const int x,
                                            const int y) {
	...
	if (entity == nullptr) {
		...
		remove_at_coords(
			world_data,
			Chunk_tile::chunkLayer::entity,
			t_entity->tile_width,
			t_entity->tile_height,
			x,
			y,
...
void jactorio::game::place_sprite_at_coords(World_data& world_data,
...
void jactorio::game::place_at_coords(World_data& world_data,
                                     const Chunk_tile::chunkLayer layer,
                                     const uint8_t tile_width,
                                     const uint8_t tile_height,
                                     const int x,
...
void jactorio::game::remove_at_coords(World_data& world_data,
                                      const Chunk_tile::chunkLayer layer,
                                      const uint8_t tile_width,
                                      const uint8_t tile_height,
                                      int x,
