...
void jactorio::game::ChunkTile::SetTilePrototype(const data::Tile* tile_prototype, const ChunkLayer category) const {
...
void jactorio::game::ChunkTile::SetEntityPrototype(const data::Entity* tile_prototype, const ChunkLayer category) const {
