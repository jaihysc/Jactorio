...
// ======================================================================
// Tile
jactorio::data::Tile* jactorio::game::chunk_tile_getter::get_tile_prototype(
	const Chunk_tile& chunk_tile, const Chunk_tile::chunkLayer category) {

	assert(category == Chunk_tile::chunkLayer::base);
	return static_cast<data::Tile*>(chunk_tile.layers[Chunk_tile::get_layer_index(category)].prototype_data);
}
...
// ======================================================================
// Entity
jactorio::data::Entity* jactorio::game::chunk_tile_getter::get_entity_prototype(
	const Chunk_tile& chunk_tile, const Chunk_tile::chunkLayer category) {
	assert(category == Chunk_tile::chunkLayer::resource || category == Chunk_tile::chunkLayer::entity);
	return static_cast<data::Entity*>(chunk_tile.layers[Chunk_tile::get_layer_index(category)].prototype_data);
}
...
// ======================================================================
// Sprite
jactorio::data::Sprite* jactorio::game::chunk_tile_getter::get_sprite_prototype(
	const Chunk_tile& chunk_tile, const Chunk_tile::chunkLayer category) {

	assert(category == Chunk_tile::chunkLayer::overlay);
	return static_cast<data::Sprite*>(chunk_tile.layers[Chunk_tile::get_layer_index(category)].prototype_data);
}
